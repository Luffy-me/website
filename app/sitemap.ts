...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes = ["", "/projects", "/about", "/writing", "/reading", "/openhighlights", "/ozon-price-tracker", ...projects.filter((project) => !project.href).map((project) => `/projects/${project.slug}`)];
