...
export default function OzonPriceTrackerPage() {
  return <div className="site-shell op-shell"><a className="skip-link" href="#main-content">Skip to content</a><SiteSidebar active="work" /><MobileNavigation active="work" />
    <main className="page-content op-page" id="main-content">
      ...
      <section className="op-final"><p className="eyebrow">A clearer way to wait</p><h2>Stop checking.<br />Start tracking.</h2><p>Let the price come to you—and know exactly what changed when it does.</p><div className="hero-actions"><a className="button button-primary" href={chromeWebStoreUrl} target="_blank" rel="noreferrer">Get Ozon Price Tracker <span aria-hidden="true">↗</span></a><Link className="text-action" href="/projects">View all work <span aria-hidden="true">→</span></Link></div></section>
      <SiteFooter />
    </main>
  </div>;
}
