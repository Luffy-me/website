...
export default function Home() {
  return <div className="site-shell"><a className="skip-link" href="#main-content">Skip to content</a><SiteSidebar active="home" /><MobileNavigation active="home" />
    <main className="page-content" id="main-content">
      ...
      <section id="featured-work" className="ruled"><div className="section-title"><h2>Featured work</h2><Link className="soft-button" href="/projects">View work</Link></div><p className="intro">A private, local-first home for the ideas worth returning to.</p><div className="project-grid">{projects.map((project) => <ProjectCard key={project.slug} project={project} featured />)}</div></section>
